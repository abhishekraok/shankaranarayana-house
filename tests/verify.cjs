...
(async()=>{
 ...
 const routes=await page.evaluate(()=>{
  ...
  return [route('front passage',[0,0,-2],[[0,5.1]]),route('entrance to courtyard',[0,0,-2],[[0,5.25],[-4.9,5.25],[-4.9,7.0],[-3.7,7.0],[-3.7,11],[-5,10.8]]),route('house upstairs',[-13.3,.45,.95],[[-7.93,.95],[-2.65,.95]]),route('temple court',[39,0,-3.8],[[39,8.8],[33,8.8],[33,14]]),route('kitchen from court',[-5,.035,10.8],[[-8.2,10.8],[-10.05,10.8],[-10.05,15.5]]),route('lake paired stairs',[15.2,.055,-10.1],[[15.2,-12.65],[19.3,-12.65],[27.5,-12.65],[30.7,-12.65]]),route('lake paired stairs return',[30.7,.065,-12.65],[[27.5,-12.65],[19.3,-12.65],[15.2,-12.65],[15.2,-10.1]]),route('pavilion entry',[28,-.29,-43.3],[[28,-40]])];
 });
