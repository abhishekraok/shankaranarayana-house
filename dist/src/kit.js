...
export function createKit(){
  const defs={plaster:['plaster','#d3d2ba'],aqua:['plaster','#9fd6d4'],red:['red','#833d30'],wood:['wood','#43372a'],blue:['wood','#277b91'],tile:['tile','#61513e'],stone:['stone','#5c6256'],paleStone:['stone','#b8b8a1'],cream:['plaster','#ded7bb'],pink:['plaster','#ba9690'],earth:['plain','#7a4c3a'],grass:['plain','#677344']};
